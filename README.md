...
- Configurações:
  - Ajuste de volume
  - Mutar volume
  - Salvar (via localStorage)
  - Apagar progresso (permanente)
- Estatísticas de jogo
- Clicar para fazer pontos
- Comprar upgrades para acelerar o progresso
- Comprar powerups (compra única) para melhorar upgrades existentes
- Liberar conquistas
